...
DOWNLOAD_DIR = get_value("DOWNLOAD_DIR", FIMFIC_TRACKER_DIR / "downloads", Path)
TRACKER_FILE = get_value("TRACKER_FILE", FIMFIC_TRACKER_DIR / "track-data.json", Path)
